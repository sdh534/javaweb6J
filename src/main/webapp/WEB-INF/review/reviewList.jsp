...
<div class="comment-list">
	...
	<div class="comment-top">
		<div class="rating">
			...
			<button class="review-like" id="likeReview()"><i class="fas fa-heart fa-sm"></i>  ${vo2.thumb}</button>
			<button class="review-more" id="moreBtn()"><i class="far fa-ellipsis-v"></i></button>
			</div> 
